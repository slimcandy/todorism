...
export const EventListItem = (props: EventListItemProps) => {
  ...
  return (
    <div id={tripUid} className="flex w-full items-center justify-content-between h-fit border-b border-light-2 dark:border-black-3 pb-3 cursor-pointer">
      <div className="mr-3 w-full">
        <div className="mb-3">
          <TitleH3>{title}</TitleH3>
          <TextBodySmall className="text-dark-3 mt-1">{description || ""}</TextBodySmall>
        </div>
        <div>
          <Indicator isActive />
      ...
      <KebabIcon size={12} className="cursor-pointer dark:text-dark-2 text-dark-4"/>
    </div>
  );
};
