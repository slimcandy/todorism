...
import {addMember, deleteMember, getMembers, renameMember} from "../../../api_clients/api_members";
...
export const MembersPage = () => {
    ...
    const onSubmitEdit = async () => {
        ...
        await renameMember(currEvent.trip_uid, editingMember.member_uid, editingMemberName)
            .then((response) => response.json())
            .then((data: IMember) => {
                if (data) {
