    ...
    <form onSubmit={onSubmit}>
      ...
      >
        ...
        <input
          ...
          className="input w-full max-w-xs text-current pl-14 bg-todo-black-2 text-white placeholder:text-todo-dark-2 hover:placeholder:text-todo-dark-3 focus:placeholder:text-white"
          onChange={onChange}
          value={value}
        />
      </label>
