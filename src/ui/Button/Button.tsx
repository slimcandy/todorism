...
const Button = ({
  ...
  return (
    <button
      onClick={onClick}
      type={type}
      className={`text-slate-600 hover:text-slate-700 rounded-md py-2 px-1.5 focus:shadow-sm border-2 focus:border-slate-600 border-slate-300 hover:border-slate-400 focus:outline-none  ${
        variant === "primary"
